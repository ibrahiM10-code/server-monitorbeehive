...
def obtener_reporte(colmena_id, apicultor_id):
    ...
    observaciones_reporte = request.args.get("observaciones")
    if acceso:
        try:
            print("Observaciones: ", observaciones_reporte)
            ...
            pdf_stream  = genera_pdf(colmena_id, descripcion, datos_actuales, observaciones_reporte, fecha_filtro="")
            print("Sending file")
            pdf_stream.seek(0)
